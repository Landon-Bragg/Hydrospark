    ...
    try:
        ...
        for row in agg:
            ...
            result.append({
                ...
                'water_status': row.water_status or 'active',
                'shutoff_notice_at': row.shutoff_notice_at.isoformat() if row.shutoff_notice_at else None,
                'shutoff_at': row.shutoff_at.isoformat() if row.shutoff_at else None,
